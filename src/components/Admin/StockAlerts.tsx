...
const StockAlerts: React.FC = () => {
  ...
  return <div>
      <h2 className="text-2xl font-bold mb-6">庫存警報</h2>
      {/* Summary Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 flex items-center">
          ...
          <div>
            <h3 className="font-medium text-amber-800">低庫存物品</h3>
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex items-center">
          ...
          <div>
            <h3 className="font-medium text-red-800">缺貨物品</h3>
            <p className="text-2xl font-bold text-red-900">
              {outOfStockItems.length}
            </p>
            <p className="text-sm text-red-700">庫存為零的物品</p>
          </div>
        </div>
      </div>
      {/* Low Stock Items */}
