  ...
  return <div className="max-w-2xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Your items have been successfully checked out.
        </p>
      </div>
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-6">
        ...
        <div className="border-t border-b border-gray-200 py-4 mb-4">
          ...
          <div className="space-y-3">
            {cartItems.map(item => <div key={item.item_id} className="flex justify-between">
      ...
      <div className="text-center">
        <button type="button" className="px-6 py-2 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" onClick={onFinish}>
