...
export const items = [{
  ...
  image_url: 'https://images.unsplash.com/photo-1583485088034-697b5bc1b72e?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80'
}, {
  item_id: 2,
  ...
  image_url: 'https://images.unsplash.com/photo-1596443686812-2f45229eebc3?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80'
}, {
  item_id: 3,
  ...
  image_url: 'https://images.unsplash.com/photo-1612968658710-5697b1d7d053?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80'
}, {
  item_id: 4,
  ...
  image_url: 'https://images.unsplash.com/photo-1619641554018-8351f85d3e20?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80'
}, {
  item_id: 5,
  ...
  location: 'Storage Room A - Shelf 1',
  image_url: 'https://images.unsplash.com/photo-1595590424283-b8f17842773f?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80'
}, {
  item_id: 6,
  ...
  image_url: 'https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80'
}, {
  item_id: 7,
  ...
  image_url: 'https://images.unsplash.com/photo-1531346878377-a5be20888e57?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80'
}, {
  item_id: 8,
  ...
  location: 'Storage Room A - Shelf 2',
  image_url: 'https://images.unsplash.com/photo-1586282391129-76a6df230234?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80'
}];
// Inventory
...
export const getInventoryWithDetails = () => {
  return inventory.map(inv => {
    ...
    const subcategory = subcategories.find(s => s.subcategory_id === item?.subcategory_id);
    const category = categories.find(c => c.category_id === subcategory?.category_id);
    return {
      ...inv,
...
export const getTransactionsWithDetails = () => {
  return transactions.map(tx => {
    ...
    const txItems = transactionItems.filter(ti => ti.transaction_id === tx.transaction_id);
    return {
      ...tx,
